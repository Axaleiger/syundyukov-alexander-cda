...
export const HeaderMain = () => {
	...
	return (
		<header className={styles["app-header"]}>
			<img
				src={`${staticBase}/emblem.png`}
				alt="Оркестратор актива"
				className={styles["app-header-emblem"]}
			/>
			...
			<div className={styles["app-header-actions"]}>
				...
				>
					{aiMode && (
						<span className={styles["app-header-ai-spinner"]} aria-hidden />
					)}
					<span className={styles["app-header-ai-toggle-text"]}>
						ИИ-режим
					</span>
				</button>
				<div className={styles["app-header-user"]}>
					...
					<img
						...
						alt=""
						className={styles["app-header-user-avatar"]}
					/>
				</div>
			</div>
		</header>
