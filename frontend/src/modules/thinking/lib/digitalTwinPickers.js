...
const HYP_SCENARIO_TWINS = [
	{ code: "СКВ", label: "скважины", keys: ["скважин", "гтм", "грп", "регламент скваж"] },
	{ code: "ПЛА", label: "пласта", keys: ["пласт", "поров", "проницаем", "пластов"] },
	{ code: "ИНФ", label: "инфраструктуры", keys: ["инфраструктур", "трубопровод", "коллектор", "узел"] },
	{ code: "ФЛЮ", label: "флюида", keys: ["флюид", "нефт", "вода", "поток", "фаз"] },
	{ code: "ПОД", label: "подготовки", keys: ["подготовк", "сепарац", "очистк", "дебит"] },
	{ code: "ЭНЕ", label: "энергетики", keys: ["энергет", "электро", "потреблен", "нагнетан"] },
	{ code: "БУР", label: "бурения", keys: ["бурен", "башмак", "отклонен", "зенит", "ствол"] },
]
...
export function formatDigitalTwinBallLabel(segment, codes) {
	...
	if (!list.length) return segment === "hs" ? "скважины" : "ЦДП"
	if (segment === "hs") {
