...
/** Минималистичные иконки в одном стиле (обводка). */
export default function NavTabIcon({ name }) {
  ...
  switch (name) {
    ...
    case 'list':
      return (
        <svg {...svgProps}>
          <path d="M9 6h11M9 12h11M9 18h11M4 6h.01M4 12h.01M4 18h.01" stroke={stroke} strokeWidth={sw} strokeLinecap="round" />
        </svg>
      )
    case 'calendar':
      return (
        <svg {...svgProps}>
          ...
          <path d="M8 14h2M12 14h2M16 14h2M8 17h2" stroke={stroke} strokeWidth={sw} strokeLinecap="round" />
        </svg>
      )
    case 'gear':
      return (
    ...
    case 'chart':
      return (
        <svg {...svgProps}>
          <path d="M4 19h16M4 19V5M4 19l4-6 4 3 4-8 4 5" stroke={stroke} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      )
    case 'admin':
      return (
        <svg {...svgProps}>
          <path d="M12 3l7 4v6c0 5-3 8-7 9-4-1-7-4-7-9V7l7-4z" stroke={stroke} strokeWidth={sw} strokeLinejoin="round" />
