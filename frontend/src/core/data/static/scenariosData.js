...
const SCENARIO_NAMES_WITH_STAGE = [
  ...
  { name: 'Оптимизация портфеля ГТМ и прироста дебита (раздел "Добыча")', stageType: 'Добыча' },
  { name: 'Сквозной контроль CAPEX/OPEX и маржи на баррель (раздел "Разработка")', stageType: 'Разработка' },
  { name: 'Приоритизация КРС и ТРС по NPV и безопасности (раздел "Бурение и ВСР")', stageType: 'Бурение и ВСР' },
  { name: 'Предиктивное обслуживание насосного парка и УПСВ (раздел "Планирование и обустройство")', stageType: 'Планирование и обустройство' },
  { name: 'Программа снижения технологических потерь и простоев (раздел "Добыча")', stageType: 'Добыча' },
  { name: 'Ускоренный вывод скважин после бурения и ВСП (раздел "Бурение и ВСР")', stageType: 'Бурение и ВСР' },
  { name: 'Связка геомодели, запасов и плана разработки (раздел "Геологоразведка и работа с ресурсной базой")', stageType: 'Геологоразведка и работа с ресурсной базой' },
  { name: 'Логистика и склад ЗИП для ремонтных бригад (раздел "Планирование и обустройство")', stageType: 'Планирование и обустройство' },
  { name: 'Риск-менеджмент по обводнению и ПНД фонда скважин (раздел "Добыча")', stageType: 'Добыча' },
  { name: 'Нормативный график ТКРС и единое окно подрядчика (раздел "Бурение и ВСР")', stageType: 'Бурение и ВСР' },
  { name: 'Пакет быстрых мероприятий на контуре маржинального барреля (раздел "Разработка")', stageType: 'Разработка' },
  { name: 'Лицензионные обязательства и инвестиционный контур актива (раздел "Геологоразведка и работа с ресурсной базой")', stageType: 'Геологоразведка и работа с ресурсной базой' },
]
