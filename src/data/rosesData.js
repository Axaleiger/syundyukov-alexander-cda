...
export const PRODUCTION_STAGES = [
  { name: 'Разведка', value: 78, coverage: 78 },
  { name: 'Разработка', value: 82, coverage: 82 },
  { name: 'Бурение', value: 88, coverage: 88 },
  { name: 'Добыча', value: 91, coverage: 91 },
  { name: 'Завершение', value: 72, coverage: 72 },
]
...
export const OBJECTS_BY_STAGE = {
  ...
  Завершение: [
    { name: 'Консервация скважин', value: 68, coverage: 68 },
    { name: 'Ликвидация скважин', value: 70, coverage: 70 },
    { name: 'Рекультивация', value: 65, coverage: 65 },
    { name: 'Вывод из эксплуатации', value: 72, coverage: 72 },
    { name: 'Демонтаж оборудования', value: 66, coverage: 66 },
    { name: 'Остаточные запасы', value: 74, coverage: 74 },
  ],
}
